...
export default function Contact() {
  ...
  return (
    <div className="px-4 py-6 mx-auto max-w-4xl sm:px-6 sm:py-14">
      ...
      <div className="mb-6 text-center sm:mb-10">
        ...
        <h1 className="mb-2 text-2xl font-bold text-transparent sm:text-4xl sm:mb-3 bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text">
          Get in Touch
        </h1>
        <p className="text-sm leading-relaxed text-gray-500 dark:text-gray-400 font-serif italic">
          Have a question, a thought, or a story to share? I'd love to hear from you.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:items-start">
        ...
        {/* ── Contact form ── */}
        <div className="w-full flex-1 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-4 sm:p-6 lg:p-8">
          <h2 className="text-base font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">Send a Message</h2>
        ...
        {/* ── Email card ── */}
        <div className="w-full lg:w-72 shrink-0 relative overflow-hidden rounded-2xl shadow-xl bg-gradient-to-br from-amber-700 via-amber-800 to-amber-900 text-white p-5 sm:p-7">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-5 pt-4 sm:mt-6 sm:pt-5 border-t border-white/20 flex items-start gap-3">
